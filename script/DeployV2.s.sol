...
contract DeployV2 is Script {
  ...
  function run() public {
    ...
    console.log("   Args:     role=0x%s  account=<V1_REQUESTS_MANAGER_ADDRESS>", vm.toString(manager.SERVICE_ROLE()));
    console.log("");
    console.log("6. (Optional) Grant PAUSER_ROLE to security monitoring addresses");
  }

  function _getConfig(string memory product, string memory network) internal pure returns (
    address issueToken,
    address priceStorage,
    address treasury,
    address depositToken,
