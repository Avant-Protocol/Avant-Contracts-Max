...
contract SimpleTokenTest is Test {
    ...
    function setUp() public {
        ...
        bytes memory initData = abi.encodeWithSelector(SimpleToken.initialize.selector, "Test Token", "TEST");
    ...
    function test_Initialize() public {
        ...
        bytes memory initData = abi.encodeWithSelector(SimpleToken.initialize.selector, "Another Token", "ANOTHER");
    ...
    function test_Mint_Idempotent_RevertDuplicateKey() public {
        ...
        vm.expectRevert(abi.encodeWithSelector(ISimpleToken.IdempotencyKeyAlreadyExist.selector, key));
